...
# create folder structure for CellProfiler analysis
...
# use zero padding renamer for ROI-mask-images
for sample in sample_list:
...
for sample in sample_list:
    ...
    # final alignment of cropped ROIs
...
# if sample has >3000 ROIs, move files to subfolders
for sample in sample_list:
